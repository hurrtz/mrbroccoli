...
> = {
  openai: {
    ...
    tts: {
      ...
      fallbackModelIds: ["gpt-4o-mini-tts-2025-12-15", "tts-1", "tts-1-hd"],
      defaultVoice: "alloy",
      voiceFallback: "alloy",
      models: [
        withInstructions(namedModel("gpt-4o-mini-tts-2025-12-15", "GPT-4o Mini TTS")),
      ...
      voiceOptions: [
        voice("alloy", "Alloy"),
        voice("ash", "Ash"),
        voiceForModels("ballad", "Ballad", ["gpt-4o-mini-tts-2025-12-15"]),
        voiceForModels("cedar", "Cedar", ["gpt-4o-mini-tts-2025-12-15"]),
        voice("coral", "Coral"),
        voice("echo", "Echo"),
        voice("fable", "Fable"),
        voiceForModels("marin", "Marin", ["gpt-4o-mini-tts-2025-12-15"]),
        voice("onyx", "Onyx"),
        voice("nova", "Nova"),
        voice("sage", "Sage"),
        voice("shimmer", "Shimmer"),
        voiceForModels("verse", "Verse", ["gpt-4o-mini-tts-2025-12-15"]),
      ],
      languageNote:
  ...
  "alibaba-qwen-dashscope": {
    ...
    stt: {
      ...
      endpoint: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1/chat/completions",
      defaultModel: "qwen3-asr-flash-2026-02-10",
      fallbackModelIds: ["qwen3-asr-flash-2026-02-10"],
      models: [namedModel("qwen3-asr-flash-2026-02-10", "Qwen3-ASR-Flash")],
      languages: ["en", "de", "uk", "hi", "es", "fr", "it", "pt", "pt-BR", "ru", "zh-CN", "ar", "ja"],
    ...
    tts: {
      ...
      fallbackModelIds: ["qwen3-tts-flash-2025-11-27", "qwen3-tts-instruct-flash-2026-01-26"],
      defaultVoice: "Cherry",
      voiceFallback: "Cherry",
      models: [
        namedModel("qwen3-tts-flash-2025-11-27", "Qwen3-TTS-Flash"),
        withInstructions(namedModel("qwen3-tts-instruct-flash-2026-01-26", "Qwen3-TTS-Instruct-Flash")),
      ],
      ...
      voiceOptions: [
        ...
        voiceForModels("Jennifer", "Jennifer · Cinematic American", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Ryan", "Ryan · Dramatic", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Katerina", "Katerina · Mature", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Aiden", "Aiden · American", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Bodega", "Bodega · Passionate Spanish", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Sonrisa", "Sonrisa · Cheerful Latin American", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Alek", "Alek · Warm Russian", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Dolce", "Dolce · Laid-back Italian", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Sohee", "Sohee · Expressive Korean", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Ono Anna", "Ono Anna · Spirited Japanese", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Lenn", "Lenn · Rebellious German", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Emilien", "Emilien · Romantic French", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Andre", "Andre · Natural and steady", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Radio Gol", "Radio Gol · Sports commentator", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Jada", "Jada · Shanghainese", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Dylan", "Dylan · Beijing", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Li", "Li · Nanjing", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Marcus", "Marcus · Shaanxi", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Roy", "Roy · Southern Min", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Peter", "Peter · Tianjin", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Sunny", "Sunny · Sichuan", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Eric", "Eric · Sichuan", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Rocky", "Rocky · Cantonese", ["qwen3-tts-flash-2025-11-27"]),
        voiceForModels("Kiki", "Kiki · Cantonese", ["qwen3-tts-flash-2025-11-27"]),
      ],

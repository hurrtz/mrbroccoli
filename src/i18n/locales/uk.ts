...
export const uk = {
  ...
  nativeSttDescription:
    "Використовуйте розпізнавання мовлення операційної системи.",
  provider: "Провайдер",
  ...
  ttsFallbackRoutesHint:
    "Необов’язково. Додавайте лише потрібні маршрути в порядку їх перевірки. Щойно маршрут починає озвучення, я використовую його до кінця відповіді.",
  ttsFallbackNone:
  ...
  qwenSpeechUnavailableInUs:
    "Мої поточні голосові маршрути Qwen недоступні в регіоні США. Для мовлення Qwen виберіть Сінгапур або Пекін.",
  ...
  listenLanguagesHint:
    "Виберіть мови відповідей, які мають звучати добре. Я перевіряю їх у цьому порядку під час маршрутизації озвучення.",
  ...
  persistenceFailure:
    "Я не зміг зберегти дані на цьому пристрої. Не закривайте застосунок і спробуйте ще раз; після перезапуску останні зміни можуть зникнути.",
  show: "Показати",
  ...
  defaultTranscriptEmptyDescription:
    "Почніть із голосу або тексту. Я збережу розмову й відповім тут.",
  delete: "Видалити",
  ...
  drawerEmptyDescription:
    "Почніть говорити на головному екрані, і я автоматично створю розмову.",
  ...
  setupGuideIntroBody:
    "Я спочатку порожній. Додайте облікові дані зовнішніх сервісів, якими вже користуєтеся, а потім виберіть маршрути для відповідей, голосового введення, озвучення та додаткового вебконтексту.",
  setupGuideIntroNote:
  ...
  setupGuideVoiceTestBody:
    "Скажіть коротке речення. Я перевірю доступ до мікрофона, розпізнавання, налаштований маршрут відповіді та озвучення, якщо доступний відповідний голосовий маршрут.",

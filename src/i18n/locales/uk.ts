...
export const uk = {
  ...
  setupGuideIntroBody:
    "Я спочатку порожній. Додай облікові дані зовнішніх сервісів, якими вже користуєтеся, а потім вибери маршрути для відповідей, голосового введення, озвучення та додаткового вебконтексту.",
  setupGuideIntroNote:

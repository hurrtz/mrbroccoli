...
export const uk = {
  ...
  ulraModeInfo:
    "Суперрежим спочатку окремо опитує кожну готову модель із головного екрана. Потім у кожному раунді всі моделі переглядають усі попередні відповіді. Вибрана модель створює підсумкову відповідь. Матеріали обговорення передаються всім залученим провайдерам.",

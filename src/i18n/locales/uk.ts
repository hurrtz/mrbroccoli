...
export const uk: TranslationDictionary = {
  ...
  driveSessionDescription:
    "Після кожної відповіді мікрофон знову буде готовий до запису. Ви самі вирішуєте, коли думку завершено, тому паузи не обрізаються.",
  startDriveSession: "Почати режим водіння",
  stopDriveSession: "Зупинити",
  repeatDriveReply: "Повторити",
  continueDriveSession: "Продовжити",
  driveSessionListeningCue: "Слухаю.",
  driveSessionStoppedCue: "Режим водіння зупинено.",
  driveSessionReady: "Режим водіння",
  driveSessionReadyDescription:
    "Сеанс готовий. Натисніть «Продовжити», щоб знову слухати.",
  tapToSendDriveTurn: "Натисніть, щоб надіслати",
  tapToInterruptDriveReply: "Натисніть, щоб перервати",
  ...
  sentencesArrive: "У міру готовності речень",
  sentencesArriveDescription:
    "Починайте озвучення, щойно будуть готові повні речення.",
  ...
  speechEtaCountdown: "Орієнтовне очікування",
  speechEtaOvertime: "Довше за прогноз",
  phaseTimeRemaining: "Етап",
  totalTimeRemaining: "Загалом",

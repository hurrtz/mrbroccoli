...
export const uk = {
  ...
  ulraMode: "Режим Ulra",
  ulraModeHomeLabel: "Показувати режим Ulra на головному екрані",
  ulraModeSettingsDescription:
    "Дозволяє спільне обговорення кількома моделями, коли готові щонайменше дві моделі головного екрана.",
  ulraModeInfo:
    "Режим Ulra спочатку окремо опитує кожну готову модель із головного екрана. Потім у кожному раунді всі моделі переглядають усі попередні відповіді. Вибрана модель створює підсумкову відповідь. Матеріали обговорення передаються всім залученим провайдерам.",
  ...
  ulraModeFirstUseTitle: "Увімкнути режим Ulra?",
  ...
  ulraModeHighRiskTitle: "Великий запуск режиму Ulra",
  ...
  ulraModeNeedsTwoModels:
    "Для режиму Ulra потрібні щонайменше дві готові моделі на головному екрані.",
  ulraModeAllModelsFailed:
    "Усі моделі режиму Ulra завершилися помилкою до того, як вдалося сформувати відповідь.",

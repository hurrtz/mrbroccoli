...
export const uk = {
  ...
  ulraMode: "Режим Ultra",
  ulraModeHomeLabel: "Показувати режим Ultra на головному екрані",
  ulraModeSettingsDescription:
    "Дозволяє спільне обговорення кількома моделями, коли готові щонайменше дві моделі головного екрана.",
  ulraModeInfo:
    "Режим Ultra спочатку окремо опитує кожну готову модель із головного екрана. Потім у кожному раунді всі моделі переглядають усі попередні відповіді. Вибрана модель створює підсумкову відповідь. Матеріали обговорення передаються всім залученим провайдерам.",
  ulraModeRounds: "Раунди перегляду",
  ulraModeCallEstimate: ({ count }) =>
    `За поточних налаштувань приблизно ${count} викликів моделей на повідомлення.`,
  ...
  ulraModeFirstUseTitle: "Увімкнути режим Ultra?",
  ulraModeFirstUseMessage: ({ calls, models, rounds }) =>
    `За ${models} моделей і ${rounds} раундів перегляду одне повідомлення може виконати близько ${calls} викликів моделей. Це може тривати значно довше, коштувати набагато більше й передати обговорення всім залученим провайдерам.`,
  ulraModeHighRiskTitle: "Великий запуск режиму Ultra",
  ulraModeHighRiskMessage: ({ calls, models, rounds }) =>
    `${models} моделей і ${rounds} раундів перегляду можуть виконати близько ${calls} викликів моделей. Це може тривати дуже довго, використати багато токенів і досягти лімітів провайдерів. Усе одно продовжити?`,
  ulraModeEnableAction: "Увімкнути",
  ulraModeNeedsTwoModels:
    "Для режиму Ultra потрібні щонайменше дві готові моделі на головному екрані.",
  ulraModeAllModelsFailed:
    "Усі моделі режиму Ultra завершилися помилкою до того, як вдалося сформувати відповідь.",
  ...
  stopDriveSession: "Призупинити авто",
  repeatDriveReply: "Повторити останню",
  continueDriveSession: "Відновити авто",
  ...
  kokoroNotInstalled:
    "Необов’язкове завантаження. Ключ провайдера не потрібен.",
  ...
  ttsFallbackRoutesHint:
    "Необов’язково. Додавайте лише потрібні маршрути в порядку їх перевірки. Щойно маршрут починає озвучення, Пан Броколі використовує його до кінця відповіді.",
  ttsFallbackNone:
  ...
  providerVoicesLoadingHint: ({ provider }) =>
    `Пан Броколі автоматично завантажує доступні голоси з ${provider}.`,
  ...
  qwenSpeechUnavailableInUs:
    "Поточні голосові маршрути Qwen у «Пан Броколі» недоступні в регіоні США. Для мовлення Qwen виберіть Сінгапур або Пекін.",
  ...
  qwenRegionUsSpeechHint:
    "Ключі регіону США підтримують тут чат і вебпошук. Поточні маршрути STT і TTS Qwen у «Пан Броколі» потребують ключа Сінгапуру або Пекіна.",
  ...
  listenLanguagesHint:
    "Виберіть мови відповідей, які мають звучати добре. Пан Броколі перевіряє їх у цьому порядку під час маршрутизації озвучення.",
  ...
  persistenceFailure:
    "Пан Броколі не зміг зберегти дані на цьому пристрої. Не закривайте застосунок і спробуйте ще раз; після перезапуску останні зміни можуть зникнути.",
  show: "Показати",
  ...
  defaultTranscriptEmptyDescription:
    "Почніть із голосу або тексту. Пан Броколі збереже розмову й відповість тут.",
  delete: "Видалити",
  ...
  drawerEmptyDescription:
    "Почніть говорити на головному екрані, і Пан Броколі автоматично створить розмову.",
  ...
  notNow: "Не зараз",
  setupGuideIntroTitle: "Як працює Пан Броколі",
  setupGuideIntroBody:
    "Пан Броколі спочатку порожній. Додайте облікові дані зовнішніх сервісів, якими вже користуєтеся, а потім виберіть маршрути для відповідей, голосового введення, озвучення та додаткового вебконтексту.",
  setupGuideIntroNote:
  ...
  setupGuideVoiceTestBody:
    "Скажіть коротке речення. Пан Броколі перевірить доступ до мікрофона, розпізнавання, налаштований маршрут відповіді та озвучення, якщо доступний відповідний голосовий маршрут.",
  ...
  setupGuideSummaryBody:
    "Ось маршрут, який Пан Броколі використовуватиме з поточними налаштуваннями.",
  ...
  memoryModalDescription:
    "Це стисле резюме, яке Пан Броколі зберігає, коли розмова стає достатньо довгою для згортання старіших реплік.",

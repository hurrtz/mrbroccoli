...
export const uk = {
  ...
  runtimeCompatibilityOverridesDescription: ({ count }) =>
    `${count} конфігурацій моделей або налаштувань, недоступність яких підтвердив постачальник, вимкнено лише на цьому пристрої. Mr Broccoli автоматично їх оминає.`,

...
export const uk = {
  ...
  ulraModeInfo:
    "Суперрежим спочатку окремо опитує кожну готову модель із головного екрана. У кожному раунді моделі критично перевіряють останню стислу позицію кожного учасника; решта раундів пропускається після явної одностайної згоди. Вибрана модель створює підсумкову відповідь. Матеріали обговорення передаються всім залученим провайдерам.",

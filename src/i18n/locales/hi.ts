...
export const hi = {
  ...
  ulraMode: "Ultra मोड",
  ulraModeHomeLabel: "होम स्क्रीन पर Ultra मोड दिखाएँ",
  ulraModeSettingsDescription:
    "जब होम स्क्रीन के कम से कम दो मॉडल तैयार हों, तब कई मॉडलों के बीच विचार-विमर्श की अनुमति देता है।",
  ulraModeInfo:
    "Ultra मोड पहले होम स्क्रीन के हर तैयार मॉडल से अलग-अलग उत्तर माँगता है। फिर हर समीक्षा दौर में सभी मॉडल पिछले सभी उत्तरों को देखते हैं। चुना गया मॉडल अंतिम उत्तर तैयार करता है। विचार-विमर्श सभी शामिल प्रदाताओं के साथ साझा किया जाता है।",
  ...
  ulraModeFirstUseTitle: "Ultra मोड चालू करें?",
  ...
  ulraModeHighRiskTitle: "बड़ा Ultra मोड रन",
  ...
  ulraModeNeedsTwoModels:
    "Ultra मोड के लिए होम स्क्रीन पर कम से कम दो तैयार मॉडल चाहिए।",
  ulraModeAllModelsFailed:
    "उत्तर तैयार होने से पहले Ultra मोड के सभी मॉडल विफल हो गए।",

...
export const hi = {
  ...
  providerVoicesLoadingHint: ({ provider }) =>
    `मैं ${provider} से उपलब्ध आवाज़ों को स्वचालित रूप से लोड करता हूँ।`,
  ...
  qwenSpeechUnavailableInUs:
    "मेरे वर्तमान Qwen भाषण मार्ग अमेरिकी क्षेत्र में उपलब्ध नहीं हैं। Qwen भाषण के लिए सिंगापुर या बीजिंग चुनें।",
  ...
  qwenRegionUsSpeechHint:
    "यूएस-क्षेत्र कुंजियाँ यहां चैट और वेब खोज का समर्थन करती हैं। मेरे वर्तमान Qwen STT और TTS मार्गों के लिए सिंगापुर या बीजिंग कुंजी की आवश्यकता होती है।",
  ...
  listenLanguagesHint:
    "वह उत्तर भाषाएँ चुनें जिन्हें आप अच्छा सुनना चाहते हैं। स्पीच आउटपुट को रूट करते समय मैं उन्हें इसी क्रम में आज़माता हूँ।",
  ...
  runtimeCompatibilityOverridesDescription: ({ count }) =>
    `प्रदाता द्वारा अनुपलब्ध बताए गए ${count} मॉडल या सेटिंग कॉन्फ़िगरेशन केवल इस डिवाइस पर बंद हैं। मैं उन्हें अपने-आप छोड़ देता हूँ।`,
  ...
  persistenceFailure:
    "मैं इस डिवाइस पर डेटा सहेज नहीं सका। ऐप खुला रखें और पुनः प्रयास करें; पुनरारंभ के बाद हाल के परिवर्तन खो सकते हैं।",
  show: "दिखाएँ",
  ...
  drawerEmptyDescription:
    "मुख्य दृश्य से बोलना प्रारंभ करें और मैं स्वचालित रूप से एक सत्र बनाऊँगा।",
  ...
  notNow: "अभी नहीं",
  setupGuideIntroTitle: "मैं कैसे काम करता हूँ",
  setupGuideIntroBody:
    "मैं रिक्त प्रारंभ होता हूँ। आपके द्वारा पहले से उपयोग की जाने वाली बाहरी सेवाओं के लिए क्रेडेंशियल जोड़ें, फिर चुनें कि उत्तर, भाषण इनपुट, बोले गए आउटपुट और वैकल्पिक वेब संदर्भ को कैसे रूट किया जाए।",
  setupGuideIntroNote:
  ...
  setupGuideVoiceTestBody:
    "एक छोटा-सा वाक्य बोलें। स्वीकार्य वॉयस रूट उपलब्ध होने पर मैं माइक्रोफ़ोन एक्सेस, ट्रांसक्रिप्शन, कॉन्फ़िगर किए गए उत्तर रूट और बोले गए आउटपुट का परीक्षण करूँगा।",
  ...
  setupGuideSummaryBody:
    "यहाँ वह मार्ग है जिसका उपयोग मैं आपके वर्तमान कॉन्फ़िगरेशन के साथ करूँगा।",

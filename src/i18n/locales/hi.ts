...
export const hi = {
  ...
  setupGuideVoiceTestBody:
    "एक छोटा सा वाक्य बोलो. स्वीकार्य वॉयस रूट उपलब्ध होने पर Mr Broccoli माइक्रोफोन एक्सेस, ट्रांसक्रिप्शन, कॉन्फ़िगर रिप्लाई रूट और स्पोकन आउटपुट का परीक्षण करेगा।",
  ...
  memoryModalDescription:
    "यह कॉम्पैक्ट सारांश है Mr Broccoli एक बार थ्रेड को पुराने मोड़ों को संपीड़ित करने के लिए पर्याप्त लंबा हो जाने पर आगे बढ़ाता है।",

...
export const hi = {
  ...
  listenLanguagesHint:
    "वे भाषाएँ चुनें जिनमें आप मुझे अच्छा सुनना चाहते हैं। स्पीच आउटपुट को रूट करते समय मैं उन्हें इसी क्रम में आज़माता हूँ।",
  ...
  setupGuideIntroBody:
    "मैं शून्य से शुरू करता हूँ। आपके द्वारा पहले से उपयोग की जाने वाली बाहरी सेवाओं के लिए क्रेडेंशियल जोड़ें, फिर चुनें कि उत्तर, भाषण इनपुट, बोले गए आउटपुट और वैकल्पिक वेब संदर्भ को कैसे रूट किया जाए।",
  setupGuideIntroNote:

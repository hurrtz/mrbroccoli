...
export const pt = {
  ...
  ulraMode: "Modo Ulra",
  ulraModeHomeLabel: "Mostrar o modo Ulra no ecrã inicial",
  ulraModeSettingsDescription:
    "Permite a deliberação entre vários modelos quando pelo menos dois modelos do ecrã inicial estão prontos.",
  ulraModeInfo:
    "O modo Ulra consulta separadamente cada modelo pronto no ecrã inicial. Em cada ronda, todos os modelos analisam depois todas as respostas anteriores. O modelo selecionado sintetiza a resposta final. A deliberação é partilhada com todos os fornecedores envolvidos.",
  ...
  ulraModeFirstUseTitle: "Ativar o modo Ulra?",
  ...
  ulraModeHighRiskTitle: "Execução Ulra extensa",
  ...
  ulraModeNeedsTwoModels:
    "O modo Ulra precisa de pelo menos dois modelos prontos no ecrã inicial.",
  ulraModeAllModelsFailed:
    "Todos os modelos do modo Ulra falharam antes de ser possível sintetizar uma resposta.",
  ...
  googleCloudSpeechCredentialFormat: ({ provider }) =>
    `${provider} STT necessita de credenciais Google Cloud Speech no formato <project-id>|<access-token>|<location> ou no formato Gemini combinado <Gemini API key>|<project-id>|<access-token>|<location>.`,
  bytedanceSpeechCredentialFormat: ({ provider }) =>
    `${provider} STT necessita de credenciais de voz Doubao no formato <app-key>|<access-key>, opcionalmente <app-key>|<access-key>|<resource-id> ou no formato combinado <ark-api-key>|<app-key>|<access-key>|<resource-id>.`,

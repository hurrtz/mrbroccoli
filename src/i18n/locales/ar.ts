...
export const ar = {
  ...
  ulraMode: "وضع Ultra",
  ulraModeHomeLabel: "إظهار وضع Ultra على الشاشة الرئيسية",
  ulraModeSettingsDescription:
    "يتيح التشاور بين عدة نماذج عندما يكون نموذجان على الأقل من نماذج الشاشة الرئيسية جاهزين.",
  ulraModeInfo:
    "يسأل وضع Ultra أولاً كل نموذج جاهز على الشاشة الرئيسية بشكل مستقل. ثم يراجع كل نموذج جميع الإجابات السابقة في كل جولة. ويجمع النموذج المحدد الإجابة النهائية. تتم مشاركة محتوى التشاور مع جميع مزودي الخدمة المشاركين.",
  ...
  ulraModeFirstUseTitle: "هل تريد تفعيل وضع Ultra؟",
  ...
  ulraModeHighRiskTitle: "تشغيل كبير لوضع Ultra",
  ...
  ulraModeNeedsTwoModels:
    "يتطلب وضع Ultra نموذجين جاهزين على الأقل في الشاشة الرئيسية.",
  ulraModeAllModelsFailed:
    "فشلت جميع نماذج وضع Ultra قبل أن يمكن توليف رد.",

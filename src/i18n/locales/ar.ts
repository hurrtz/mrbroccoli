...
export const ar = {
  ...
  setupGuideIntroBody:
    "أبدأ من الصفر. أضف بيانات اعتماد للخدمات الخارجية التي تستخدمها بالفعل، ثم اختر كيفية توجيه الردود وإدخال الكلام والمخرجات المنطوقة وسياق الويب الاختياري.",
  setupGuideIntroNote:

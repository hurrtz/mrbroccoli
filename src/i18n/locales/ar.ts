...
export const ar = {
  ...
  ulraModeInfo:
    "يسأل الوضع الفائق أولاً كل نموذج جاهز على الشاشة الرئيسية بشكل مستقل. وفي كل جولة مراجعة، تتحدى النماذج أحدث موقف موجز لكل مشارك، وتتوقف الجولات غير المستخدمة بعد تقارب صريح بالإجماع. ويجمع النموذج المحدد الإجابة النهائية. تتم مشاركة محتوى التشاور مع جميع مزودي الخدمة المشاركين.",

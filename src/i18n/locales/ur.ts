...
export const ur = {
  ...
  ulraMode: "Ulra موڈ",
  ulraModeHomeLabel: "ہوم اسکرین پر Ulra موڈ دکھائیں",
  ulraModeSettingsDescription:
    "جب ہوم اسکرین کے کم از کم دو ماڈل تیار ہوں تو متعدد ماڈلز کے درمیان غور و فکر کی اجازت دیتا ہے۔",
  ulraModeInfo:
    "Ulra موڈ پہلے ہوم اسکرین کے ہر تیار ماڈل سے الگ الگ جواب لیتا ہے۔ پھر ہر جائزہ مرحلے میں تمام ماڈل پچھلے تمام جوابات کا جائزہ لیتے ہیں۔ منتخب ماڈل آخری جواب تیار کرتا ہے۔ غور و فکر تمام شامل فراہم کنندگان کے ساتھ شیئر کیا جاتا ہے۔",
  ...
  ulraModeFirstUseTitle: "Ulra موڈ فعال کریں؟",
  ...
  ulraModeHighRiskTitle: "بڑا Ulra موڈ رن",

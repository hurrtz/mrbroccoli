...
export const ur = {
  ...
  ulraMode: "Ultra موڈ",
  ulraModeHomeLabel: "ہوم اسکرین پر Ultra موڈ دکھائیں",
  ulraModeSettingsDescription:
    "جب ہوم اسکرین کے کم از کم دو ماڈل تیار ہوں تو متعدد ماڈلز کے درمیان غور و فکر کی اجازت دیتا ہے۔",
  ulraModeInfo:
    "Ultra موڈ پہلے ہوم اسکرین کے ہر تیار ماڈل سے الگ الگ جواب لیتا ہے۔ پھر ہر جائزہ مرحلے میں تمام ماڈل پچھلے تمام جوابات کا جائزہ لیتے ہیں۔ منتخب ماڈل آخری جواب تیار کرتا ہے۔ غور و فکر تمام شامل فراہم کنندگان کے ساتھ شیئر کیا جاتا ہے۔",
  ulraModeRounds: "جائزہ مراحل",
  ulraModeCallEstimate: ({ count }) =>
    `موجودہ ترتیب کے ساتھ فی پیغام تقریباً ${count} ماڈل کالز۔`,
  ...
  ulraModeFirstUseTitle: "Ultra موڈ فعال کریں؟",
  ulraModeFirstUseMessage: ({ calls, models, rounds }) =>
    `${models} ماڈلز اور ${rounds} جائزہ مراحل کے ساتھ ایک پیغام تقریباً ${calls} ماڈل کالز کر سکتا ہے۔ اس میں بہت زیادہ وقت اور لاگت لگ سکتی ہے اور غور و فکر تمام شامل فراہم کنندگان کے ساتھ شیئر ہوگا۔`,
  ulraModeHighRiskTitle: "بڑا Ultra موڈ رن",
  ...
  ulraModeNeedsTwoModels:
    "Ultra موڈ کے لیے ہوم اسکرین پر کم از کم دو تیار ماڈلز درکار ہیں۔",
  ulraModeAllModelsFailed:
    "جواب تیار ہونے سے پہلے Ultra موڈ کے تمام ماڈلز ناکام ہو گئے۔",
  ...
  googleCloudSpeechCredentialFormat: ({ provider }) =>
    `${provider} STT کو <project-id>|<access-token>|<location> فارمیٹ میں Google Cloud Speech اسناد کی ضرورت ہے، یا مشترکہ Gemini فارمیٹ <Gemini API key>|<project-id>|ZXQPH8QZQZ9|`,
  bytedanceSpeechCredentialFormat: ({ provider }) =>
    `${provider} STT کو <app-key>|<access-key> فارمیٹ میں Doubao تقریر کی اسناد کی ضرورت ہے، اختیاری طور پر <app-key>|<access-key>|<resource-id>، یا مشترکہ شکل <ark-api-key>|<app-key>|<access-key>|<resource-id>۔`,

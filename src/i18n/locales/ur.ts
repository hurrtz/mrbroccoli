...
export const ur = {
  ...
  ttsFallbackRoutesHint:
    "اختیاری۔ صرف وہی راستے شامل کریں جو آپ چاہتے ہیں، اسی ترتیب میں جس سے انہیں آزمایا جانا چاہیے۔ ایک بار جب کوئی راستہ بولنا شروع کر دے، میں باقی جواب کے لیے اسی پر رہتا ہوں۔",
  ttsFallbackNone:
  ...
  providerVoicesLoadingHint: ({ provider }) =>
    `میں دستیاب آوازوں کو ${provider} سے خود بخود لوڈ کرتا ہوں۔`,
  ...
  listenLanguagesHint:
    "وہ جوابی زبانیں چنیں جن کی آواز آپ اچھی چاہتے ہیں۔ اسپیچ آؤٹ پٹ کو روٹ کرتے وقت میں انہیں اسی ترتیب میں آزماتا ہوں۔",
  ...
  runtimeCompatibilityOverridesDescription: ({ count }) =>
    `فراہم کنندہ کی جانب سے غیر دستیاب قرار دی گئی ${count} ماڈل یا ترتیب کنفیگریشنز صرف اس ڈیوائس پر بند ہیں۔ میں خودکار طور پر ان سے بچتا ہوں۔`,
  ...
  persistenceFailure:
    "میں اس آلہ پر ڈیٹا محفوظ نہیں کر سکا۔ ایپ کو کھلا رکھیں اور دوبارہ کوشش کریں۔ دوبارہ شروع کرنے کے بعد حالیہ تبدیلیاں ضائع ہو سکتی ہیں۔",
  show: "دکھائیں۔",
  ...
  defaultTranscriptEmptyDescription:
    "شروع کرنے کے لیے آواز یا متن کا استعمال کریں۔ میں تھریڈ کو برقرار رکھوں گا اور یہاں جواب دوں گا۔",
  delete: "حذف کریں۔",
  ...
  setupGuideIntroBody:
    "میں صفر سے شروع کرتا ہوں۔ بیرونی خدمات کے لیے اسناد شامل کریں جو آپ پہلے سے استعمال کرتے ہیں، پھر منتخب کریں کہ جوابات، اسپیچ ان پٹ، بولی جانے والی آؤٹ پٹ، اور اختیاری ویب سیاق و سباق کو کیسے روٹ کیا جاتا ہے۔",
  setupGuideIntroNote:
  ...
  setupGuideSummaryBody:
    "یہ وہ راستہ ہے جو میں آپ کی موجودہ ترتیب کے ساتھ استعمال کروں گا۔",

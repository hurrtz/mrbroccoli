...
export const ur = {
  ...
  ulraModeInfo:
    "اعلیٰ موڈ پہلے ہوم اسکرین کے ہر تیار ماڈل سے الگ الگ جواب لیتا ہے۔ پھر ہر جائزہ مرحلے میں تمام ماڈل پچھلے تمام جوابات کا جائزہ لیتے ہیں۔ منتخب ماڈل آخری جواب تیار کرتا ہے۔ غور و فکر تمام شامل فراہم کنندگان کے ساتھ شیئر کیا جاتا ہے۔",

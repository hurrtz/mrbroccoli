...
export const hu = {
  ...
  settingsGuidedSetupSummary:
    "Tekintsd át a kapcsolatokat, és teszteld a teljes hangútvonalat.",
  ...
  recognitionLanguageHint:
    "Válassz nyelvet a felismerés javításához, vagy hagyja automatikusan az eszköz vagy szolgáltató észleléséhez.",
  ...
  instructionsTabDescription:
    "Alakítsd ki a rejtett útmutatást, amely az asszisztenst irányítja, mielőtt bármely szolgáltató látná a kérést.",
  providersTabDescription:
    "Tárold a külső szolgáltatás hitelesítő adatait az eszközön, és konfiguráld a használni kívánt válaszmódokat.",
  webSearchTabDescription:
    "Konfiguráld az opcionális élő webes környezetet a válaszok előtt.",
  responseModes: "Modell kiválasztása",
  aboutModelSelection: "A modellválasztásról",
  modelSelectionInfo:
    "Minden modellkártya választható lesz a kezdőképernyőn. Konfiguráld a szolgáltatót, a modellt és az opcionális gondolkodási szintet, majd kártyaváltással döntsd el, melyik modell válaszoljon legközelebb.",
  ...
  sttTabDescription:
    "Szabályozhatod, hogyan rögzítsd a beszédet, és melyik háttérprogram alakítja át a hangot szöveggé, mielőtt az elérné a modellt.",
  ttsTabDescription:
    "Szabályozhatod, hogy a válaszok mikor kezdjenek el beszélni, és hogy melyik háttérrendszer kezelje a hangkimenetet.",
  brief: "Rövid",
  briefDescription:
    "Tartsd szorosan a választ. Használj minimális számú mondatot ahhoz, hogy teljes körű választ adjon a felhasználónak.",
  normal: "Normál",
  normalDescription:
    "Törekedj kiegyensúlyozott válaszhosszra. Térj ki a fontos pontokra, de ne nyújtsd el a választ.",
  thorough: "Alapos",
  thoroughDescription:
    "Menj mélyre, és legyen átfogó. Tartalmazz árnyalatokat, részleteket, kompromisszumokat és az érvelést, ami számít.",
  professional: "Professzionális",
  professionalDescription:
    "Beszélj úgy, mint egy vezető tanácsadó, aki tájékoztatja az ügyfelet. Precíz nyelvezet, nincs szleng, kimért és mérvadó.",
  casual: "Közvetlen",
  casualDescription:
    "Beszélj úgy, mint egy okos barát egy kávézóban: lazán, természetesen és közvetlenül. A rövidítések és a kisebb kitérők is beleférnek.",
  nerdy: "Kocka",
  nerdyDescription:
    "Úgy beszélj, mint egy lelkes szakértő, aki szeret elmélyülni a témában. Használd szabadon a szakmai terminológiát, merülj el lelkesen a részletekben, és feltételezd, hogy a felhasználó lépést tud tartani.",
  concise: "Tömör",
  conciseDescription:
    "Légy a lehető legrövidebb, de attól még teljes. Se felvezetés, se töltelékszöveg, csak a válasz. Mintha táviratot írna.",
  socratic: "Szókratikus",
  socraticDescription:
    "Kérdőjelezd meg a felhasználó gondolkodását. Tegy fel ellenkérdéseket, kínálj alternatív nézőpontokat, ne csak erősítsd meg, amit mondtak. Légy vitapartner, ne bólogató gép.",
  eli5: "ELI5",
  eli5Description:
    "Magyarázz el mindent a lehető legegyszerűbben. Használj analógiákat és hétköznapi nyelvet, szakzsargon nélkül. Feltételezd, hogy a felhasználónak egyetlen témában sincs előzetes tudása.",
  ...
  providerValidationUnavailable:
    "Az élő érvényesítés még nincs bekötve ennél a szolgáltatónál. Mentsd el a kulcsot itt, és ellenőrizd a tényleges használat során.",
  ...
  assistantInstructionsIntro:
    "Alakítsd ki a rejtett útmutatást, amelyet a modell minden válasz előtt kap.",
  baseInstructions: "Alaputasítások",
  assistantInstructionsPlaceholder:
    "Határozd meg, hogyan viselkedjen az asszisztens.",
  ...
  styleSheetSubtitle:
    "Csak ehhez a beszélgetéshez alakítsd ki a válaszokat és a beszédet.",
  ...
  conversationThinkingInstructionsDescription:
    "Adj hozzá utasításokat ehhez a beszélgetéshez a globális rendszerparancs után.",
  conversationThinkingInstructionsPlaceholder:
    "Például: Kérdezd meg a feltevéseimet, és használj konkrét példákat.",
  ...
  conversationTtsInstructionsDescription:
    "Add hozzá a kézbesítési utasításokat a beszélgetés globális beszédutasításai után.",
  ttsInstructionsPlaceholder:
    "Például: beszélj melegen, világosan és nyugodt tempóban.",
  ...
  conversationVoiceDescription: ({ route }) =>
    `Válaszd ki a ${route} által ebben a beszélgetésben használt hangot.`,
  ...
  conversationTitleNeedsContent:
    "Indíts beszélgetést a cím generálása előtt.",
  conversationTitleNeedsProvider:
    "A cím generálása előtt konfiguráld a kiválasztott modellt.",
  conversationTitleGenerationFailed:
    "Nem sikerült létrehozni a beszélgetés címét.",
  conversationTitleGenerationTimedOut:
    "A cím generálása túl sokáig tartott. Próbáld újra.",
  ...
  toggleToTalkDescription:
    "Koppints egyszer a felvétel elindításához, majd koppints újra, ha végzett.",
  driveSession: "Vezetési mód",
  driveSessionDescription:
    "Ha az automatikus folytatás be van kapcsolva, a felvétel minden szóbeli válasz után elindul. Koppints a fő gombra, ha befejezte a beszédet.",
  ...
  nativeSttDescription:
    "Használd az operációs rendszer beszédfelismerőjét.",
  provider: "Szolgáltató",
  webSearchProvider: "Webes keresőszolgáltató",
  webSearchProviderMissingHint:
    "Konfigurálj legalább egy keresésre alkalmas szolgáltatást a hitelesítő adatoknál, hogy itt bekapcsolhassa az élő webes kontextust.",
  webSearchModelHint: ({ model }) =>
    `A háttérben a(z) ${model} modellt használd az élő webes kontextushoz.`,
  webSearchHomeHint:
  ...
  expandAdvancedSearch: "Bővítsd ki a speciális keresési vezérlőket",
  collapseAdvancedSearch: "A speciális keresési vezérlők összecsukása",
  webSearchSetupNeeded:
    "Adj hozzá hitelesítő adatokat az élő webes keresés használatához.",
  webSearchEnabledDescription:
    "Friss webes környezet kerül hozzáadásra, mielőtt a modell válaszolna.",
  webSearchDisabledDescription:
    "Használj élő webes környezetet ehhez a szálhoz, ha az aktuális tények számítanak.",
  ...
  providerSttDescription:
    "Használj konfigurált külső szolgáltatást hangjának átírására, mielőtt elküldené a válaszútvonalra.",
  ...
  sttProviderMissingHint:
    "Adj hozzá hitelesítő adatokat egy STT-támogatással rendelkező szolgáltatáshoz, hogy itt válassza ki azt.",
  nativeSttHint:
  ...
  nativeTtsDescription:
    "Használd az eszköz beszédmotorját a szóbeli válaszokhoz és a hangelőnézethez.",
  kokoroTtsDescription:
    "Használj sokkal természetesebb neurális hangot, teljes egészében ezen az eszközön. A szóbeli válasz szövege helyben szintetizálódik, beszédszolgáltatói kulcs és használati díj nélkül.",
  ...
  kokoroNotInstalled:
    "A Kokoro kiválasztása vagy használata előtt töltsd le és ellenőrizd a modellt. Nincs szükség szolgáltatói kulcsra.",
  ...
  removeKokoroModel: "Távolítsd el a Kokoro modellt",
  downloadKokoroModel: "Töltsd le a Kokoro modellt",
  ...
  voiceOutputDescription:
    "Válaszd ki a beszédmotort, a felolvasási nyelveket és a hangelőnézeteket a szóbeli válaszokhoz.",
  localTts: "Helyi",
  localTtsDescription:
    "Használj megfelelő letöltött helyi hangot a szóbeli válaszokhoz.",
  providerTtsDescription:
    "A kiválasztott konfigurált szolgáltatást használd a szóbeli válaszokhoz.",
  ttsFallbackRoutes: "Tartalék útvonalak",
  ttsFallbackRoutesHint:
    "Opcionális. Csak a kívánt útvonalakat adja hozzá, a kipróbálás sorrendjében. Amint egy útvonal beszélni kezd, azt használom a válasz hátralévő részében.",
  ttsFallbackNone:
  ...
  ttsProviderMissingHint:
    "Adj hozzá hitelesítő adatokat egy TTS-támogatással rendelkező szolgáltatáshoz, hogy itt válassza ki azt.",
  localTtsOrderHint:
    "Csak kifejezetten konfigurált tartalék útvonalakat kísérel meg a rendszer.",
  providerTtsOrderHint:
    "Csak kifejezetten konfigurált tartalék útvonalakat kísérel meg a rendszer.",
  nativeTtsHint:
    "A natív TTS a rendszer hangveremét használd, és nem igényel szolgáltatói kulcsot.",
  ...
  elevenLabsVoicesReadPermissionHint:
    "Az ElevenLabsban szerkessze ezt az API-kulcsot, engedélyezd a Voices → Read jogosultságot, majd frissítsd itt.",
  providerVoicesLoadingHint: ({ provider }) =>
    `Automatikusan betöltöm az elérhető hangokat a(z) ${provider} szolgáltatótól.`,
  providerVoiceId: "Hangazonosító",
  providerVoiceIdPlaceholder: "Adj meg egy hangazonosítót",
  ...
  listenLanguagesHint:
    "Válaszd ki azokat a válasznyelveket, amelyeken jó minőségű felolvasást szeretne. Ebben a sorrendben próbálom ki őket a hangkimenet irányításakor.",
  listenLanguagesSelected: ({ count }) =>
    count === 1 ? "1 nyelv kiválasztva" : `${count} nyelv kiválasztva`,
  localVoicePacks: "Helyi hangcsomagok",
  localVoicePacksHint:
    "Minden nyelv megtartja saját helyi hangját. Válaszd ki az adott nyelvhez kívánt hangot, majd csak azokat a csomagokat töltsd le, amelyek valóban fontosak.",
  ...
  providerVoicePreviewsHint:
    "Teszteld le az aktuálisan kiválasztott TTS-útvonalat itt, külön előnézeti szöveggel minden válasznyelvhez.",
  ...
  runtimeCompatibilityOverridesDescription: ({ count }) =>
    `${count} szolgáltató által igazoltan nem elérhető modell- vagy beállításkonfiguráció csak ezen az eszközön van letiltva. Automatikusan elkerülöm ezeket.`,
  ...
  speechDiagnosticsEmpty:
    "Még nincs újabb beszédkérelem. Tekintsd meg a hang előnézetét vagy játsszon le egy választ, hogy itt megtekinthesse az útvonal részleteit.",
  clearSpeechDiagnosticsConfirmationTitle:
    "Törlöd a legutóbbi beszédtevékenységet?",
  ...
  localTtsPackBroken:
    "Letöltve, de ennek a hangnak a helyi ellenőrzése nem sikerült ezen az eszközön. Töltsd le újra, vagy válasszon másik hangot.",
  localTtsPackMissing:
  ...
  voicePreviewPlaceholder:
    "Gépelj be egy kifejezést, hogy meghalld ezt a hangot.",
  voicePreviewHint:
    "Az aktuálisan kiválasztott válaszhang-backendet használd anélkül, hogy bármit is küldene a nyelvi modellnek.",
  ...
  replyFailedHint: "Válassz másik modellt fent, mielőtt újra próbálkozna.",
  spokenReplyFailed: "A válasz el lett mentve, de nem lehetett kimondani.",
  retrySpeech: "Próbáld újra a beszédet",
  ...
  addProviderKeyToUseProvider: ({ provider }) =>
    `Add hozzá a(z) ${provider} hitelesítő adatait a Beállításokban az útvonal használata előtt.`,
  configureCredentialsBeforeVoiceSession:
    "Adj hozzá hitelesítő adatokat a Beállításokban, mielőtt hangos munkamenetet kezdene.",
  ...
  chooseSttBeforeVoiceSession:
    "Válassz egy konfigurált STT-útvonalat a Beállításokban a hangos munkamenet indítása előtt.",
  chooseTtsBeforeSpokenReplies:
    "Válassz egy konfigurált TTS-útvonalat a Beállításokban a szóbeli válaszok használata előtt.",
  stopSessionBeforeReplay:
    "Az utolsó válasz lejátszása előtt állítsd le az aktív hangos munkamenetet.",
  couldntCatchThatTryAgain: "Ezt nem sikerült érteni, próbáld újra.",
  ...
  sttRecordingTooLarge: ({ provider, limit }) =>
    `A felvétel túl hosszú a(z) ${provider} beszédátírásához (max. ${limit}). Próbálkozz rövidebb üzenettel, vagy állítsd át a Beszéd szöveggé beállítást Rendszerfelismerésre.`,
  addProviderKeyToEnableProvider: ({ provider }) =>
    `Add hozzá a(z) ${provider} hitelesítő adatait a Beállításokban az útvonal használata előtt.`,
  stopSessionBeforePreview:
    "A hang előnézetének meghallgatása előtt állítsd le az aktív hangos munkamenetet.",
  chooseTtsToPreviewVoices:
    "Válassz egy konfigurált TTS-útvonalat a Beállításokban a hangok előnézetének megtekintéséhez.",
  downloadSelectedLocalVoiceFirst: ({ languageLabel }) =>
    `Először töltsd le a kiválasztott ${languageLabel} helyi hangot.`,
  ...
  persistenceFailure:
    "Nem tudtam adatokat menteni ezen az eszközön. Tartsd nyitva az alkalmazást, és próbáld újra; a legutóbbi módosítások újraindítás után elveszhetnek.",
  show: "Megjelenítés",
  ...
  reportResponseIntro:
    "AI-válasz jelentése a Mr Broccoli alkalmazásból. Nézd át az alábbi tartalmat, írja le a problémát, és küldje el a jelentést a fejlesztőnek.",
  repeatReply: "Válasz megismétlése",
  renameThread: "Szál átnevezése",
  renameThreadHint:
    "Adj ennek a beszélgetésnek olyan címet, amelyet később gyorsan megtalálhat.",
  threadTitle: "Szálcím",
  noTranscriptYet: "Még nincs átirat",
  previewTranscriptEmptyDescription:
    "A kezdéshez használj hangot vagy szöveget. A beszélgetés itt fog megjelenni.",
  noConversationYet: "Még nincs beszélgetés",
  expandedTranscriptEmptyDescription:
    "A kezdéshez használj hangot vagy szöveget. Zárd be ezt a képernyőt, ha vissza szeretne térni a fő színpadra.",
  transcriptSelectionHint:
    "Válaszd ki közvetlenül az üzenet szövegét, vagy ossza meg és másold az egyes üzeneteket alább.",
  ...
  debugLogButtonHiddenDescription:
    "Tartsd rejtve a kezdőképernyő LOG gombját, hacsak nem fut már a rögzítés.",
  ...
  debugLogButtonUsageDescription:
    "A gomb használata: bekapcsolása megkezdi a naplók rögzítését. Ha kikapcsolod, leáll a naplók rögzítése, és a rögzítettek átkerülnek a vágólapra.",
  ...
  setupGuideConnectProviderDescription:
    "Adj hozzá hitelesítő adatokat a Beállításokban, majd válassza ki a használni kívánt útvonalakat.",
  idle: "Tétlen",
  yourConversationAppearsHere: "A beszélgetésed itt jelenik meg",
  defaultTranscriptEmptyDescription:
    "A kezdéshez használj hangot vagy szöveget. Megőrzöm a beszélgetést, és itt válaszolok.",
  delete: "Törlés",
  deleteConversationConfirmationTitle: ({ title }) =>
    `Törlöd a „${title}” elemet?`,
  deleteConversationConfirmationMessage:
    "Ez véglegesen törli a beszélgetést és az összes üzenetét. Ez a művelet nem vonható vissza.",
  conversations: "Beszélgetések",
  drawerSubtitle: "Ugorj az élő szálak közé, vagy nyiss új szobát.",
  newSession: "Új munkamenet",
  noSavedConversationsYet: "Még nincsenek mentett beszélgetések",
  drawerEmptyDescription:
    "Kezdj el beszélni a főnézetben, és automatikusan létrehozok egy munkamenetet.",
  setupGuideTitle: "Konfiguráld az alkalmazást",
  setupGuideSubtitle:
    "Adj hozzá hitelesítő adatokat, és válasszon útvonalakat a Beállításokban.",
  fastestStartPreset: "Minimális beállítás",
  fastestStartDescription:
    "Ahol elérhető, használd az eszköz saját beszédfunkcióit, és csak a szükséges válaszútvonalat konfiguráld.",
  fullVoicePreset: "Konfigurált hang",
  fullVoiceDescription:
    "Használd a konfigurált szolgáltatásokat a válaszokhoz, az átíráshoz és a szóbeli kimenethez, amikor kiválasztja őket.",
  setupGuideNote:
    "Ezután megnyitjuk a Beállításokat, hogy beilleszthesse és ellenőrizhesse a hitelesítő adatokat.",
  useThisSetup: "Használd ezt a beállítást",
  notNow: "Most nem",
  ...
  setupGuideProviderBody:
    "Válaszd ki a konfigurálni kívánt külső szolgáltatást, majd illessze be a hitelesítő adatokat válaszhozzáféréssel.",
  setupGuideProviderPickerLabel: "Válaszszolgáltatás",
  setupGuideSelectProvider: "Válassz szolgáltatót",
  ...
  setupGuideApiKeyRequiredOrCancel:
    "Adj hozzá egy API-kulcsot a folytatáshoz, vagy szakítsd meg a beállítási útmutatót.",
  setupGuideProviderAndApiKeyRequiredOrCancel:
    "Válassz szolgáltatót, és adjon hozzá API-kulcsot a folytatáshoz, vagy szakítsd meg a beállítási útmutatót.",
  setupGuideProviderKeyNeedsLlmAccess: ({ provider }) =>
    `Ezek a ${provider} hitelesítő adatok nem teszik lehetővé a válaszkéréseket.`,
  setupGuideKokoroTitle: "Adj hozzá egy természetes hangot az eszközön",
  setupGuideKokoroBody: ({ size }) =>
    `Opcionális: töltsd le a Kokoro-t (körülbelül ${size} MB) a sokkal természetesebb szóbeli válaszokért, beszédszolgáltató és használati díjak nélkül.`,
  setupGuideKokoroLanguageNote:
    "Ez a modell jelenleg angolul és egyszerűsített kínaiul beszél. Konfiguráld a későbbiekben kívánt tartalék útvonalakat a Beszéd beállításaiban.",
  setupGuideKokoroDownload: "A Kokoro letöltése",
  setupGuideUseKokoro: "Használd a Kokoro-t a szóbeli válaszokhoz",
  setupGuideUseKokoroSummary:
    "Tartsd a szintézist a telefonon, amikor a válasznyelv támogatott.",
  setupGuideSkipKokoro: "Kihagyás most",
  setupGuideVoiceTestTitle: "Teszteld le beállításait",
  setupGuideVoiceTestBody:
    "Mondj egy rövid mondatot. Tesztelem a mikrofonhozzáférést, az átírást, a beállított válaszútvonalat és – ha elérhető megfelelő hangútvonal – a hangkimenetet.",
  setupGuideVoiceTestNoInputBody:
    "A hangbevitel nem érhető el ezzel a beállítással. Folytassa az észlelt útvonalak áttekintését, majd szükség esetén módosítsd a beszédbeállításokat később.",
  setupGuideVoiceTestTextOnlyNote:
    "Ez a teszt csak szöveges marad, mert még nem áll rendelkezésre elfogadható beszédútvonal.",
  setupGuideVoiceTestStart: "Indítsd el a tesztet",
  ...
  setupGuideSummaryBody:
    "Ezt az útvonalat fogom használni a jelenlegi beállításokkal.",
  ...
  noMatchingConversationsDescription:
    "Próbálj más címet, útvonalat, modellt vagy kifejezést az átiratból.",
  ...
  keepPressing: "Tartsd nyomva",
  tapWhenDone: "Ha kész, koppints rá",
  speechPaused: "A beszéd szünetel",
  pausePlaybackUnavailable:
    "Ezt a hangútvonalat nem lehet szüneteltetni. Állítsd le, vagy válts szolgáltatói hangkimenetre.",
  holdToSpeak: "Tartsd nyomva beszéd közben",
  tapToSpeak: "Koppints a beszédhez",
  tapAgainToSend: "Koppints újra a küldéshez",
  ...
  providerNetworkError: ({ provider, action }) =>
    `Nem sikerült elérni a(z) ${provider} szolgáltatót ${action} esetén. Ellenőrizd a kapcsolatot, és próbáld újra.`,
  providerAuthError: ({ provider, action }) =>
    `${provider} elutasította a(z) ${action} művelet hitelesítő adatait. Ellenőrizd az API-kulcsot és az engedélyeket.`,
  providerRateLimitError: ({ provider, action }) =>
    `${provider} jelenleg korlátozza a(z) ${action} kéréseket. Próbáld újra egy pillanat múlva.`,
  providerCreditsRequired: ({ provider, action }) =>
    `${provider} elegendő API-egyenleget igényel a(z) ${action} művelethez. Ellenőrizd a fiók egyenlegét és a kulcs költési korlátját.`,
  providerTimeoutError: ({ provider, action }) =>
    `${provider} túl sokáig tartott a ${action} során. Próbáld újra.`,
  providerTemporaryError: ({ provider, action }) =>
    `${provider} átmeneti problémát tapasztalt a ${action} alatt. Próbáld újra rövidesen.`,
  providerEmptyReplyError: ({ provider }) =>
    `${provider} válasz nélkül fejeződött be. Próbáld újra.`,
  providerIncompleteReplyError: ({ provider }) =>
    `${provider} válasza megszakadt, mielőtt elkészült volna. Próbáld újra.`,
  providerContextTooLong: ({ provider }) =>
    `${provider} elutasította a választ, mert a beszélgetés túl hosszúra sikerült. Indíts új szálat, vagy rövidítsd le a kérést.`,
  ...
  chooseTextToSpeechProviderInSettings:
    "Válassz szövegfelolvasó szolgáltatót a Beállításokban.",
  ...
  sttFileSizeLimitExceeded: ({ provider, model, limit }) =>
    `${provider} ${model} csak ${limit}-ig fogad felvételeket. Használj rövidebb klipet, vagy válts másik STT-modellre.`,
  voiceInputCaptureIncomplete:
    "A hangbevitelt nem sikerült tisztán rögzíteni. Próbáld újra.",
  ...
  chooseSpeechToTextProviderInSettings:
    "Válassz beszéd-szöveg szolgáltatót a Beállításokban.",

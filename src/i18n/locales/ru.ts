...
export const ru = {
  ...
  ttsFallbackRoutesHint:
    "Необязательно. Добавляйте только те маршруты, которые вам нужны, в том порядке, в котором их следует пробовать. Как только маршрут начал озвучивать ответ, я остаюсь на нём до конца ответа.",
  ttsFallbackNone:
  ...
  qwenSpeechUnavailableInUs:
    "Мои текущие речевые маршруты Qwen недоступны в регионе США. Для речевых функций Qwen выберите Сингапур или Пекин.",
  ...
  listenLanguagesHint:
    "Выберите языки ответов, которые должны звучать хорошо. Я пробую их в этом порядке при выборе речевого вывода.",
  ...
  persistenceFailure:
    "Мне не удалось сохранить данные на этом устройстве. Оставьте приложение открытым и повторите попытку; последние изменения могут быть потеряны после перезапуска.",
  show: "Показать",
  ...
  defaultTranscriptEmptyDescription:
    "Чтобы начать, используйте голос или текст. Я сохраню эту тему и отвечу здесь.",
  delete: "Удалить",
  ...
  drawerEmptyDescription:
    "Начните говорить с главного экрана, и я автоматически создам сеанс.",
  ...
  setupGuideIntroBody:
    "Я начинаю пустым. Добавьте учетные данные для внешних служб, которые вы уже используете, затем выберите способ маршрутизации ответов, речевого ввода, речевого вывода и дополнительного веб-контекста.",
  setupGuideIntroNote:
  ...
  setupGuideVoiceTestBody:
    "Скажите короткое предложение. Я проверю доступ к микрофону, транскрипцию, настроенный маршрут ответа и голосовой вывод, если доступен приемлемый голосовой маршрут.",
  ...
  setupGuideSummaryBody:
    "Вот маршрут, который я буду использовать с вашей текущей конфигурацией.",

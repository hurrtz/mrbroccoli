...
export const ru = {
  ...
  ttsFallbackRoutesHint:
    "Необязательный. Добавляйте только те маршруты, которые вам нужны, в том порядке, в котором их следует опробовать. Как только маршрут начинает говорить, Mr Broccoli остается на нем до конца ответа.",
  ttsFallbackNone:
  ...
  qwenSpeechUnavailableInUs:
    "Текущие речевые маршруты Mr Broccoli Qwen недоступны в регионе США. Выберите Сингапур или Пекин для выступления Qwen.",
  ...
  qwenRegionUsSpeechHint:
    "Ключи региона США поддерживают чат и веб-поиск здесь. Для текущих маршрутов Mr Broccoli Qwen STT и TTS требуется ключ Сингапура или Пекина.",
  ...
  listenLanguagesHint:
    "Выберите языки ответов, на которых вы хотите, чтобы они звучали хорошо. Mr Broccoli пробует их в этом порядке при маршрутизации речевого вывода.",
  ...
  memoryModalDescription:
    "Это компактное описание, которое Mr Broccoli переносит дальше, когда поток становится достаточно длинным, чтобы сжимать старые витки.",

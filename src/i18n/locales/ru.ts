...
export const ru = {
  ...
  setupGuideIntroBody:
    "Я начинаю пустым. Добавь учетные данные для внешних служб, которые ты уже используешь, затем выбери способ маршрутизации ответов, речевого ввода, речевого вывода и дополнительного веб-контекста.",
  setupGuideIntroNote:

...
export const ru = {
  ...
  ulraModeHomeLabel: "Показывать режим Ultra на главном экране",
  ulraModeSettingsDescription:
    "Разрешает совместное обсуждение несколькими моделями, когда готовы как минимум две модели главного экрана.",
  ulraModeInfo:
    "Режим Ultra сначала отдельно опрашивает каждую готовую модель с главного экрана. Затем в каждом раунде все модели изучают все предыдущие ответы. Выбранная модель формирует итоговый ответ. Материалы обсуждения передаются всем задействованным провайдерам.",
  ulraModeRounds: "Раунды проверки",
  ulraModeCallEstimate: ({ count }) =>
    `При текущих настройках примерно ${count} вызовов моделей на сообщение.`,
  ...
  ulraModeFirstUseTitle: "Включить режим Ultra?",
  ulraModeFirstUseMessage: ({ calls, models, rounds }) =>
    `При ${models} моделях и ${rounds} раундах проверки одно сообщение может выполнить около ${calls} вызовов моделей. Это может занять намного больше времени, заметно увеличить стоимость и передать обсуждение всем задействованным провайдерам.`,
  ulraModeHighRiskTitle: "Большой запуск режима Ultra",
  ulraModeHighRiskMessage: ({ calls, models, rounds }) =>
    `${models} моделей и ${rounds} раундов проверки могут выполнить около ${calls} вызовов моделей. Это может занять очень много времени, израсходовать много токенов и достичь лимитов провайдеров. Всё равно продолжить?`,
  ulraModeEnableAction: "Включить",
  ulraModeNeedsTwoModels:
    "Для режима Ultra нужны как минимум две готовые модели на главном экране.",
  ulraModeAllModelsFailed:
    "Все модели режима Ultra завершились с ошибкой до того, как удалось составить ответ.",

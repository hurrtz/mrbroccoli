...
export const ru = {
  ...
  nativeSttDescription:
    "Используйте распознаватель речи операционной системы. В зависимости от настроек устройства распознавание может выполняться на устройстве или через системный сервис. Ключ провайдера не требуется.",
  provider: "Провайдер",

...
export const ru = {
  ...
  ulraMode: "Режим Ulra",
  ulraModeHomeLabel: "Показывать режим Ulra на главном экране",
  ulraModeSettingsDescription:
    "Разрешает совместное обсуждение несколькими моделями, когда готовы как минимум две модели главного экрана.",
  ulraModeInfo:
    "Режим Ulra сначала отдельно опрашивает каждую готовую модель с главного экрана. Затем в каждом раунде все модели изучают все предыдущие ответы. Выбранная модель формирует итоговый ответ. Материалы обсуждения передаются всем задействованным провайдерам.",
  ...
  ulraModeFirstUseTitle: "Включить режим Ulra?",
  ...
  ulraModeHighRiskTitle: "Большой запуск режима Ulra",
  ...
  ulraModeNeedsTwoModels:
    "Для режима Ulra нужны как минимум две готовые модели на главном экране.",
  ulraModeAllModelsFailed:
    "Все модели режима Ulra завершились с ошибкой до того, как удалось составить ответ.",

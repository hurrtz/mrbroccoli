...
export const ru = {
  ...
  ulraModeInfo:
    "Суперрежим сначала отдельно опрашивает каждую готовую модель с главного экрана. В каждом раунде модели критически проверяют последнюю краткую позицию каждого участника; оставшиеся раунды пропускаются после явного единогласного согласия. Выбранная модель формирует итоговый ответ. Материалы обсуждения передаются всем задействованным провайдерам.",

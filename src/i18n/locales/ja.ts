...
export const ja = {
  ...
  ulraMode: "Ultraモード",
  ulraModeHomeLabel: "ホーム画面にUltraモードを表示",
  ulraModeSettingsDescription:
    "ホーム画面のモデルが2件以上使用可能なときに、複数モデルによる検討を有効にします。",
  ulraModeInfo:
    "Ultraモードは、まずホーム画面で使用可能な各モデルに個別に回答を求めます。その後、各レビューラウンドで全モデルがそれまでの全回答を確認します。選択中のモデルが最終回答をまとめます。検討内容は関係するすべてのプロバイダーと共有されます。",
  ...
  ulraModeNeedsTwoModels:
    "Ultraモードには、ホーム画面で使用可能なモデルが2つ以上必要です。",
  ulraModeAllModelsFailed:
    "回答を統合する前に、Ultraモードのすべてのモデルが失敗しました。",

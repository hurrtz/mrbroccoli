  ...
  return (
    <div
      ...
      style={{
        ...
        padding: 14, borderRadius: "var(--mb-radius-panel)",
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <button type="button" aria-label="Dismiss" onClick={onDismiss} style={{ width: 44, height: 44, borderRadius: "var(--mb-radius-icon-button)", border: "1px solid var(--mb-color-border)", background: "var(--mb-color-surface)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>

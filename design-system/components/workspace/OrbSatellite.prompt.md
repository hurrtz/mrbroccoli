...
The ring is phase-owned: idle shows the composing controls (image, council, web); every other phase shows the transport verbs (Restart · Back · Forward · Stop) with `disabled` on the three seek verbs until the speaking phase — Stop is always live. See `guidelines/surfaces/workspace.md`.
